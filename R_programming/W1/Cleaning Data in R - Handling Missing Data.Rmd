...
## Example 
# ---
# Question: Re-code /fill the missing value in a column with a number
# ---
# OUR CODE GOES BELOW
#
dt$Age[is.na(dt$Age)] <- 99 # with condition of check missing values fill them wth a certain number
...
## Example
# ---
# Question: Re-code or fill the missing value in a column with the mean value of the column-#-
# ---
# OUR CODE GOES BELOW
#
...
## Challenge 2
# ---
# Question: Clean the given data set 
# ---
# Data set url = http://bit.ly/MS- PropertyDataset
# ---
# OUR CODE GOES BELOW
# 
colSums(is.na(bus_dataset))

# data looks clean no need to clean
```
...
# 
library('data.table')
air_quality <- fread('http://bit.ly/AirQualityDataset')
